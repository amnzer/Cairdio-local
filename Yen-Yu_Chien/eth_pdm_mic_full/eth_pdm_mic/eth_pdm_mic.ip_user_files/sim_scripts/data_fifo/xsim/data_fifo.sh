...
#
# Script generated by Vivado on Wed Oct 23 15:15:49 -0500 2024
...
# script info
echo -e "data_fifo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_fifo xil_defaultlib.data_fifo xil_defaultlib.glbl -log elaborate.log
}
