...
design_libs=(xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 cic_compiler_v4_0_16 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key cic_compiler_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cic_compiler_0_simv.daidir vcs_lib c.obj)
