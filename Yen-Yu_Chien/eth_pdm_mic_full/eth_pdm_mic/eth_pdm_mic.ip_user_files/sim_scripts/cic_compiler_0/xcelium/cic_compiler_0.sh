...
#
# Script generated by Vivado on Wed Oct 23 15:13:14 -0500 2024
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname cic_compiler_v4_0_16 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 cic_compiler_v4_0_16 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cic_compiler_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvhdl -work cic_compiler_v4_0_16 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cic_compiler_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cic_compiler_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cic_compiler_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
